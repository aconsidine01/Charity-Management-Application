...
class HomePageCharities extends React.Component {
                        ...
                        <div key={charities.pk_user_id}>
                            <td>
                                <div class="col-md-4" >
                                    ...
                                    <a class="btn btn-secondary btn-sm" href="/charities" role="button">View details &raquo;</a>
                                </div>
                            </td>
                        </div>
                    )}
...
export default HomePageCharities;